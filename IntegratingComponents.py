...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        # 2) Initalize the EmbeddingClient from Task 4 with embed 
        ...
        with st.form("Load Data to Chroma"):
            ...
            if submitted:
                ...
                # 5) Use the create_chroma_collection() method to create a Chroma collection from the processed 
                chroma_creator.create_chroma_collection()
                
                    
                # Uncomment the following lines to test the query_chroma_collection() method
                user_input_query = st.text_input("Input user query")    
                ...
                # if document:
                #     st.write("Chroma Collection is created and the top document for the query is : ")
                #     st.write(document)
                # else: 
                #     st.write("Chroma Collection is not created")