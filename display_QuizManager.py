...
if __name__ == "__main__":
    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        st.session_state['question_bank'] = [] # Step 1: init the question bank list in st.session_state
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                questions = st.slider("Number of Questions",min_value=1,max_value=10,value=1)# Step 2: Set topic input and number of questions
    ...
    if st.session_state.get('display_quiz',False):
        ...
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                # Step 8:Unpack choices for radio button
                choices = []
